 ...
 * scanned image. OCR is the only way to read it, so that one file falls back
 * to OCR even when the scan is running in regular mode. Files that do have a
 * text layer are unaffected: the regular-scan default does not change.
 */
