...
const names = [
  'coreUtils','textQuality','bankRecognizer','summaryExtractor','accountNumber','statementDate','transactionParser','reconciliation',
...
test('company normalizer stable', () => assert.equal(E.companyAggregator.normalizeCompanyKey('Test Company, LLC'), 'test company llc'));
