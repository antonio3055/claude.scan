          ...
          <details className="more-menu">
            ...
            <div className="menu-card">
              ...
              <div className="scan-settings">
                ...
                <label>Regular pages
                  <input type="number" min="1" max="9999" value={props.settings.regularPages} onChange={(e) => props.onSettings({ ...props.settings, regularPages: Math.max(1, Number(e.target.value) || 9999) })} />
                </label>
                <label>OCR pages
                  <input type="number" min="1" max="9999" value={props.settings.ocrPages} onChange={(e) => props.onSettings({ ...props.settings, ocrPages: Math.max(1, Number(e.target.value) || 9999) })} />
                </label>
              </div>
            </div>
          </details>
