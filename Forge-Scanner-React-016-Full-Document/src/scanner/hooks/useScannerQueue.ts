...
export const DEFAULT_SCAN_SETTINGS: ScanSettings = {
  mode: 'regular',
  // Every page is read by default in both modes. Math.min(doc.numPages,
  // pageLimit) in extractPdfText/ocrPdfPages naturally caps this to whatever
  // the document actually has, so this is "no limit", not a literal count.
  regularPages: 9999,
  ocrPages: 9999,
  maxFiles: 500,
