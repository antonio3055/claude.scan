...
const names = [
  'coreUtils','textQuality','bankRecognizer','holderAddress',
  'companyName','balanceEquation','summaryExtractor','accountNumber','statementDate','transactionParser','reconciliation',
